            ...
            <section className="bg-z-card border border-z-border rounded-xl p-6 shadow-xl">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div className="space-y-2">
                  ...
                  <input required type="text" value={titre} onChange={(e) => setTitre(e.target.value)} className="w-full bg-z-bg border border-z-border rounded-lg p-3 text-sm focus:border-z-blue focus:outline-none" />
                </div>
                <div className="space-y-2">
                ...
                sousProjets.map(sp => (
                  <div key={sp.id} className="bg-z-bg border border-z-border rounded-lg p-4 group">
                    <div className="flex justify-between items-start">
                      ...
                      <button onClick={() => handleDeleteSousProjet(sp.id)} className="text-z-muted hover:text-red-400 p-1 transition-colors">
                        <Trash2 size={14} />
                      </button>
                    </div>
                  </div>
